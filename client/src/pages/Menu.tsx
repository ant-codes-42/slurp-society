            ...
            <div className="menu-container">
                ...
                <ul className="menu-list">
                    <li className="menu-item">
                        <h4 className="menu-item-title">The Scrumptious Schwab &nbsp;&nbsp;&nbsp;18.95</h4>
                    ...
                    <li className="menu-item">
                        <h4 className="menu-item-title">The Vital Vincent &nbsp;&nbsp;&nbsp; 16.95</h4>
                    ...
                    <li className="menu-item">
                        <h4 className="menu-item-title">The Legendary Lindsey &nbsp;&nbsp;&nbsp; 14.95</h4>
                    ...
                    <li className="menu-item">
                        <h4 className="menu-item-title">The Tasty Tristan &nbsp;&nbsp;&nbsp; 14.95</h4>
